...
const { rightSaleBody, saleCreateResponse, allProductsResponse, allSaleResponse, deleteSaleResponse, updateSaleResponse, idSaleResponse } = require('../../../__tests__/_dataMock');
